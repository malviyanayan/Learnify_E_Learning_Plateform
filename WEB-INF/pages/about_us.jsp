                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="mt-5">
                                        <h4
                                            ...
                                            <i class="fas fa-envelope text-success fs-3 fw-bold"></i> Contact Us
                                        </h4>
                                        <form id="contactForm">
                                            <input type="hidden" name="access_key"
                                                value="5a241610-e6f4-4a13-9e1f-fbcb2126e0cd">
                                        ...
                                        <script>
                                            document.getElementById("contactForm").addEventListener("submit", async function (e) {
                                                ...
                                                // Optional: show loading icon/text
                                                statusDiv.innerHTML = `<i class="fas fa-spinner fa-spin"></i> Submitting...`;

                                                try {
                                                    const response = await fetch("https://formspree.io/f/mwpkqjoy", {
                                                        method: "POST",
                                                        body: formData,
                                                        headers: {
                                                    ...
                                                    if (response.ok) {
                                                        statusDiv.innerHTML = `<i class="fas fa-check-circle" style="color:green;"></i> Your Query has been submitted!`;
                                                        form.reset();
                                                    } else {
                                                        statusDiv.innerHTML = `<i class="fas fa-exclamation-circle" style="color:red;"></i> There was a problem submitting the form.`;
                                                    }
                                                } catch (error) {
                                                    statusDiv.innerHTML = `<i class="fas fa-times-circle" style="color:red;"></i> Something went wrong. Please try again.`;
                                                }
                                            });
                                        </script>
